package pe.com.bn.mgtt.persistence.dto.internal.ws;
...
public class DTOConsultaMovimientosExpediente {
    ...
    private String mov1CodAutorizacion;
    private String mov1NumTarjeta;
    ...
    private String mov2CodAutorizacion;
    private String mov2NumTarjeta;
    ...
    private String mov3CodAutorizacion;
    private String mov3NumTarjeta;
    ...
    private String mov4CodAutorizacion;
    private String mov4NumTarjeta;
 ...
 // Mov5
     ...
     private String mov5CodAutorizacion;
     private String mov5NumTarjeta;
  ...
  // Mov6
     ...
     private String mov6CodAutorizacion;
     private String mov6NumTarjeta;
     ...
     private String mov7CodAutorizacion;
     private String mov7NumTarjeta;
     ...
     private String mov8CodAutorizacion;
     private String mov8NumTarjeta;
     ...
     private String mov9CodAutorizacion;
     private String mov9NumTarjeta;
     ...
     private String mov10CodAutorizacion;
     private String mov10NumTarjeta;
     ...
     private String mov11CodAutorizacion;
     private String mov11NumTarjeta;
     ...
     private String mov12CodAutorizacion;
     private String mov12NumTarjeta;
     ...
     private String mov13CodAutorizacion;
     private String mov13NumTarjeta;
     ...
     private String mov14CodAutorizacion;
     private String mov14NumTarjeta;
     ...
     private String mov15CodAutorizacion;
     private String mov15NumTarjeta;
     ...
     private String mov16CodAutorizacion;
     private String mov16NumTarjeta;
     ...
     private String mov17CodAutorizacion;
     private String mov17NumTarjeta;
     ...
     private String mov18CodAutorizacion;
     private String mov18NumTarjeta;
     ...
     private String mov19CodAutorizacion;
     private String mov19NumTarjeta;
     ...
     private String mov20CodAutorizacion;
     private String mov20NumTarjeta;
	...
	@XmlElement(name = "Mov1CodAutorizacion")
	public String getMov1CodAutorizacion() {
		return mov1CodAutorizacion;
	}

	public void setMov1CodAutorizacion(String mov1CodAutorizacion) {
		this.mov1CodAutorizacion = mov1CodAutorizacion;
	}

	@XmlElement(name = "Mov1NumTarjeta")
	public String getMov1NumTarjeta() {
		return mov1NumTarjeta;
	}

	public void setMov1NumTarjeta(String mov1NumTarjeta) {
		this.mov1NumTarjeta = mov1NumTarjeta;
	}
	...
	public String getMov2Operacion() {
		return mov2Operacion;
	}

	public void setMov2Operacion(String mov2Operacion) {
		this.mov2Operacion = mov2Operacion;
	}

	@XmlElement(name = "Mov2CodAutorizacion")
	public String getMov2CodAutorizacion() {
		return mov2CodAutorizacion;
	}

	public void setMov2CodAutorizacion(String mov2CodAutorizacion) {
		this.mov2CodAutorizacion = mov2CodAutorizacion;
	}

	@XmlElement(name = "Mov2NumTarjeta")
	public String getMov2NumTarjeta() {
		return mov2NumTarjeta;
	}

	public void setMov2NumTarjeta(String mov2NumTarjeta) {
		this.mov2NumTarjeta = mov2NumTarjeta;
	}
	...
	public String getMov3Operacion() {
		return mov3Operacion;
	}

	public void setMov3Operacion(String mov3Operacion) {
		this.mov3Operacion = mov3Operacion;
	}

	@XmlElement(name = "Mov3CodAutorizacion")
	public String getMov3CodAutorizacion() {
		return mov3CodAutorizacion;
	}

	public void setMov3CodAutorizacion(String mov3CodAutorizacion) {
		this.mov3CodAutorizacion = mov3CodAutorizacion;
	}

	@XmlElement(name = "Mov3NumTarjeta")
	public String getMov3NumTarjeta() {
		return mov3NumTarjeta;
	}

	public void setMov3NumTarjeta(String mov3NumTarjeta) {
		this.mov3NumTarjeta = mov3NumTarjeta;
	}
	...
	public String getMov4Operacion() {
		return mov4Operacion;
	}

	public void setMov4Operacion(String mov4Operacion) {
		this.mov4Operacion = mov4Operacion;
	}

	@XmlElement(name = "Mov4CodAutorizacion")
	public String getMov4CodAutorizacion() {
		return mov4CodAutorizacion;
	}

	public void setMov4CodAutorizacion(String mov4CodAutorizacion) {
		this.mov4CodAutorizacion = mov4CodAutorizacion;
	}

	@XmlElement(name = "Mov4NumTarjeta")
	public String getMov4NumTarjeta() {
		return mov4NumTarjeta;
	}

	public void setMov4NumTarjeta(String mov4NumTarjeta) {
		this.mov4NumTarjeta = mov4NumTarjeta;
	}
	...
	public String getMov5Operacion() {
		return mov5Operacion;
	}

	public void setMov5Operacion(String mov5Operacion) {
		this.mov5Operacion = mov5Operacion;
	}

	@XmlElement(name = "Mov5CodAutorizacion")
	public String getMov5CodAutorizacion() {
		return mov5CodAutorizacion;
	}

	public void setMov5CodAutorizacion(String mov5CodAutorizacion) {
		this.mov5CodAutorizacion = mov5CodAutorizacion;
	}

	@XmlElement(name = "Mov5NumTarjeta")
	public String getMov5NumTarjeta() {
		return mov5NumTarjeta;
	}

	public void setMov5NumTarjeta(String mov5NumTarjeta) {
		this.mov5NumTarjeta = mov5NumTarjeta;
	}
	...
	public String getMov6Operacion() {
		return mov6Operacion;
	}

	public void setMov6Operacion(String mov6Operacion) {
		this.mov6Operacion = mov6Operacion;
	}

	@XmlElement(name = "Mov6CodAutorizacion")
	public String getMov6CodAutorizacion() {
		return mov6CodAutorizacion;
	}

	public void setMov6CodAutorizacion(String mov6CodAutorizacion) {
		this.mov6CodAutorizacion = mov6CodAutorizacion;
	}

	@XmlElement(name = "Mov6NumTarjeta")
	public String getMov6NumTarjeta() {
		return mov6NumTarjeta;
	}

	public void setMov6NumTarjeta(String mov6NumTarjeta) {
		this.mov6NumTarjeta = mov6NumTarjeta;
	}
	...
	public String getMov7Operacion() {
		return mov7Operacion;
	}

	public void setMov7Operacion(String mov7Operacion) {
		this.mov7Operacion = mov7Operacion;
	}

	@XmlElement(name = "Mov7CodAutorizacion")
	public String getMov7CodAutorizacion() {
		return mov7CodAutorizacion;
	}

	public void setMov7CodAutorizacion(String mov7CodAutorizacion) {
		this.mov7CodAutorizacion = mov7CodAutorizacion;
	}

	@XmlElement(name = "Mov7NumTarjeta")
	public String getMov7NumTarjeta() {
		return mov7NumTarjeta;
	}

	public void setMov7NumTarjeta(String mov7NumTarjeta) {
		this.mov7NumTarjeta = mov7NumTarjeta;
	}
	...
	public String getMov8Operacion() {
		return mov8Operacion;
	}

	public void setMov8Operacion(String mov8Operacion) {
		this.mov8Operacion = mov8Operacion;
	}

	@XmlElement(name = "Mov8CodAutorizacion")
	public String getMov8CodAutorizacion() {
		return mov8CodAutorizacion;
	}

	public void setMov8CodAutorizacion(String mov8CodAutorizacion) {
		this.mov8CodAutorizacion = mov8CodAutorizacion;
	}

	@XmlElement(name = "Mov8NumTarjeta")
	public String getMov8NumTarjeta() {
		return mov8NumTarjeta;
	}

	public void setMov8NumTarjeta(String mov8NumTarjeta) {
		this.mov8NumTarjeta = mov8NumTarjeta;
	}
	...
	public String getMov9Operacion() {
		return mov9Operacion;
	}

	public void setMov9Operacion(String mov9Operacion) {
		this.mov9Operacion = mov9Operacion;
	}

	@XmlElement(name = "Mov9CodAutorizacion")
	public String getMov9CodAutorizacion() {
		return mov9CodAutorizacion;
	}

	public void setMov9CodAutorizacion(String mov9CodAutorizacion) {
		this.mov9CodAutorizacion = mov9CodAutorizacion;
	}

	@XmlElement(name = "Mov9NumTarjeta")
	public String getMov9NumTarjeta() {
		return mov9NumTarjeta;
	}

	public void setMov9NumTarjeta(String mov9NumTarjeta) {
		this.mov9NumTarjeta = mov9NumTarjeta;
	}
	...
	public String getMov10Operacion() {
		return mov10Operacion;
	}

	public void setMov10Operacion(String mov10Operacion) {
		this.mov10Operacion = mov10Operacion;
	}

	@XmlElement(name = "Mov10CodAutorizacion")
	public String getMov10CodAutorizacion() {
		return mov10CodAutorizacion;
	}

	public void setMov10CodAutorizacion(String mov10CodAutorizacion) {
		this.mov10CodAutorizacion = mov10CodAutorizacion;
	}

	@XmlElement(name = "Mov10NumTarjeta")
	public String getMov10NumTarjeta() {
		return mov10NumTarjeta;
	}

	public void setMov10NumTarjeta(String mov10NumTarjeta) {
		this.mov10NumTarjeta = mov10NumTarjeta;
	}
	...
	public String getMov11Operacion() {
		return mov11Operacion;
	}

	public void setMov11Operacion(String mov11Operacion) {
		this.mov11Operacion = mov11Operacion;
	}

	@XmlElement(name = "Mov11CodAutorizacion")
	public String getMov11CodAutorizacion() {
		return mov11CodAutorizacion;
	}

	public void setMov11CodAutorizacion(String mov11CodAutorizacion) {
		this.mov11CodAutorizacion = mov11CodAutorizacion;
	}

	@XmlElement(name = "Mov11NumTarjeta")
	public String getMov11NumTarjeta() {
		return mov11NumTarjeta;
	}

	public void setMov11NumTarjeta(String mov11NumTarjeta) {
		this.mov11NumTarjeta = mov11NumTarjeta;
	}
	...
	public String getMov12Operacion() {
		return mov12Operacion;
	}

	public void setMov12Operacion(String mov12Operacion) {
		this.mov12Operacion = mov12Operacion;
	}

	@XmlElement(name = "Mov12CodAutorizacion")
	public String getMov12CodAutorizacion() {
		return mov12CodAutorizacion;
	}

	public void setMov12CodAutorizacion(String mov12CodAutorizacion) {
		this.mov12CodAutorizacion = mov12CodAutorizacion;
	}

	@XmlElement(name = "Mov12NumTarjeta")
	public String getMov12NumTarjeta() {
		return mov12NumTarjeta;
	}

	public void setMov12NumTarjeta(String mov12NumTarjeta) {
		this.mov12NumTarjeta = mov12NumTarjeta;
	}
	...
	public String getMov13Operacion() {
		return mov13Operacion;
	}

	public void setMov13Operacion(String mov13Operacion) {
		this.mov13Operacion = mov13Operacion;
	}

	@XmlElement(name = "Mov13CodAutorizacion")
	public String getMov13CodAutorizacion() {
		return mov13CodAutorizacion;
	}

	public void setMov13CodAutorizacion(String mov13CodAutorizacion) {
		this.mov13CodAutorizacion = mov13CodAutorizacion;
	}

	@XmlElement(name = "Mov13NumTarjeta")
	public String getMov13NumTarjeta() {
		return mov13NumTarjeta;
	}

	public void setMov13NumTarjeta(String mov13NumTarjeta) {
		this.mov13NumTarjeta = mov13NumTarjeta;
	}
	...
	public String getMov14Operacion() {
		return mov14Operacion;
	}

	public void setMov14Operacion(String mov14Operacion) {
		this.mov14Operacion = mov14Operacion;
	}

	@XmlElement(name = "Mov14CodAutorizacion")
	public String getMov14CodAutorizacion() {
		return mov14CodAutorizacion;
	}

	public void setMov14CodAutorizacion(String mov14CodAutorizacion) {
		this.mov14CodAutorizacion = mov14CodAutorizacion;
	}

	@XmlElement(name = "Mov14NumTarjeta")
	public String getMov14NumTarjeta() {
		return mov14NumTarjeta;
	}

	public void setMov14NumTarjeta(String mov14NumTarjeta) {
		this.mov14NumTarjeta = mov14NumTarjeta;
	}
	...
	public String getMov15Operacion() {
		return mov15Operacion;
	}

	public void setMov15Operacion(String mov15Operacion) {
		this.mov15Operacion = mov15Operacion;
	}

	@XmlElement(name = "Mov15CodAutorizacion")
	public String getMov15CodAutorizacion() {
		return mov15CodAutorizacion;
	}

	public void setMov15CodAutorizacion(String mov15CodAutorizacion) {
		this.mov15CodAutorizacion = mov15CodAutorizacion;
	}

	@XmlElement(name = "Mov15NumTarjeta")
	public String getMov15NumTarjeta() {
		return mov15NumTarjeta;
	}

	public void setMov15NumTarjeta(String mov15NumTarjeta) {
		this.mov15NumTarjeta = mov15NumTarjeta;
	}
	...
	public String getMov16Operacion() {
		return mov16Operacion;
	}

	public void setMov16Operacion(String mov16Operacion) {
		this.mov16Operacion = mov16Operacion;
	}

	@XmlElement(name = "Mov16CodAutorizacion")
	public String getMov16CodAutorizacion() {
		return mov16CodAutorizacion;
	}

	public void setMov16CodAutorizacion(String mov16CodAutorizacion) {
		this.mov16CodAutorizacion = mov16CodAutorizacion;
	}

	@XmlElement(name = "Mov16NumTarjeta")
	public String getMov16NumTarjeta() {
		return mov16NumTarjeta;
	}

	public void setMov16NumTarjeta(String mov16NumTarjeta) {
		this.mov16NumTarjeta = mov16NumTarjeta;
	}
	...
	public String getMov17Operacion() {
		return mov17Operacion;
	}

	public void setMov17Operacion(String mov17Operacion) {
		this.mov17Operacion = mov17Operacion;
	}

	@XmlElement(name = "Mov17CodAutorizacion")
	public String getMov17CodAutorizacion() {
		return mov17CodAutorizacion;
	}

	public void setMov17CodAutorizacion(String mov17CodAutorizacion) {
		this.mov17CodAutorizacion = mov17CodAutorizacion;
	}

	@XmlElement(name = "Mov17NumTarjeta")
	public String getMov17NumTarjeta() {
		return mov17NumTarjeta;
	}

	public void setMov17NumTarjeta(String mov17NumTarjeta) {
		this.mov17NumTarjeta = mov17NumTarjeta;
	}
	...
	public String getMov18Operacion() {
		return mov18Operacion;
	}

	public void setMov18Operacion(String mov18Operacion) {
		this.mov18Operacion = mov18Operacion;
	}

	@XmlElement(name = "Mov18CodAutorizacion")
	public String getMov18CodAutorizacion() {
		return mov18CodAutorizacion;
	}

	public void setMov18CodAutorizacion(String mov18CodAutorizacion) {
		this.mov18CodAutorizacion = mov18CodAutorizacion;
	}

	@XmlElement(name = "Mov18NumTarjeta")
	public String getMov18NumTarjeta() {
		return mov18NumTarjeta;
	}

	public void setMov18NumTarjeta(String mov18NumTarjeta) {
		this.mov18NumTarjeta = mov18NumTarjeta;
	}
	...
	public String getMov19Operacion() {
		return mov19Operacion;
	}

	public void setMov19Operacion(String mov19Operacion) {
		this.mov19Operacion = mov19Operacion;
	}

	@XmlElement(name = "Mov19CodAutorizacion")
	public String getMov19CodAutorizacion() {
		return mov19CodAutorizacion;
	}

	public void setMov19CodAutorizacion(String mov19CodAutorizacion) {
		this.mov19CodAutorizacion = mov19CodAutorizacion;
	}

	@XmlElement(name = "Mov19NumTarjeta")
	public String getMov19NumTarjeta() {
		return mov19NumTarjeta;
	}

	public void setMov19NumTarjeta(String mov19NumTarjeta) {
		this.mov19NumTarjeta = mov19NumTarjeta;
	}
	...
	public String getMov20Operacion() {
		return mov20Operacion;
	}

	public void setMov20Operacion(String mov20Operacion) {
		this.mov20Operacion = mov20Operacion;
	}

	@XmlElement(name = "Mov20CodAutorizacion")
	public String getMov20CodAutorizacion() {
		return mov20CodAutorizacion;
	}

	public void setMov20CodAutorizacion(String mov20CodAutorizacion) {
		this.mov20CodAutorizacion = mov20CodAutorizacion;
	}

	@XmlElement(name = "Mov20NumTarjeta")
	public String getMov20NumTarjeta() {
		return mov20NumTarjeta;
	}

	public void setMov20NumTarjeta(String mov20NumTarjeta) {
		this.mov20NumTarjeta = mov20NumTarjeta;
	}
